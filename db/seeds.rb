...
adminUser.add_role (vwl.name + adminUser.id.to_s)
adminUser.add_role (bwl.name + adminUser.id.to_s)
adminUser.add_role (it.name + adminUser.id.to_s)
adminUser.add_role (rw.name + adminUser.id.to_s)
adminUser.add_role (se.name + adminUser.id.to_s)
